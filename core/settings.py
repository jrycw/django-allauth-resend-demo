...
SECRET_KEY = "django-insecure-4#)=y(0wqtg_6(iji3$d-^x#wws--@3)a&tvrz1%k3vz_bh1ab"
...
# resend
# ref:
# https://github.com/resend/resend-django-smtp-example/blob/main/resend_django_smtp_example/settings.py
# https://github.com/resend/resend-django-smtp-example/blob/main/resend_django_smtp_example/views.py
#
